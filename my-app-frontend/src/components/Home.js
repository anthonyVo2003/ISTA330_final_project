...
const HomePage = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      ...
      {/* Features Section */}
      <Container ref={featuresRef} className="text-center my-5">
        <h2 className="mb-5" style={{ fontWeight: 'bold', fontSize: '2.5rem', color: '#333' }}>
          Why Choose FitTrack?
        </h2>
        <Row className="g-4">
          {[
            ...
            <Col key={index} md={4}>
              ...
              >
                <div className="glass-card shadow-lg p-4 rounded-4 h-100">
                  <h3 style={{ fontWeight: '600', marginBottom: '1rem' }}>{feature.title}</h3>
        ...
        <motion.div
          ...
          className="mt-5 p-4 rounded-4 shadow-lg bg-dark text-white"
